package com.example.bmw.vehicle.services.webservice.common;
...
/**
 * Container response filter to add the HTTP headers necessary to enable CORS for our REST API.
 *
 * Note: This base class is NOT annotated with {@link Provider} so that it is not automatically
 * applied to all modules that have a dependency to this module.
 *
 * In order to activate CORS for your module, extend this base class and add annotation {@link Provider}.
 *
 * @author Clive Jevons, MaibornWolff
 */
